...
// Simple Material-style outline paths (24×24 viewBox)
const PATHS: Record<IconName, string> = {
  // Apps grid: 4 rounded squares arranged 2×2
  applications:
    'M3 3h8v8H3V3zm0 10h8v8H3v-8zm10-10h8v8h-8V3zm0 10h8v8h-8v-8z',
  // Flow/workflow: three nodes connected by arrows
  workflows:
    'M3 12h4m0 0l-2-2m2 2l-2 2M9 12h6m0 0l-2-2m2 2l-2 2M17 12h4M5 6a2 2 0 1 0 0-4 2 2 0 0 0 0 4zm14 0a2 2 0 1 0 0-4 2 2 0 0 0 0 4zm0 16a2 2 0 1 0 0-4 2 2 0 0 0 0 4z',
  // Actors / people: two person silhouettes
  actors:
    'M16 11c1.66 0 2.99-1.34 2.99-3S17.66 5 16 5c-1.66 0-3 1.34-3 3s1.34 3 3 3zm-8 0c1.66 0 2.99-1.34 2.99-3S9.66 5 8 5C6.34 5 5 6.34 5 8s1.34 3 3 3zm0 2c-2.33 0-7 1.17-7 3.5V19h14v-2.5c0-2.33-4.67-3.5-7-3.5zm8 0c-.29 0-.62.02-.97.05 1.16.84 1.97 1.97 1.97 3.45V19h6v-2.5c0-2.33-4.67-3.5-7-3.5z',
  // Subscriptions / broadcast: RSS/signal arcs
  subscriptions:
